    ...
    <>
      ...
      <div className="hidden lg:hidden md:flex flex-col h-screen overflow-hidden">
        ...
        <div className="relative h-full lg:w-1/2 flex flex-col items-center justify-start text-center space-y-10">
          ...
          <div className="relative z-10 flex flex-col h-full justify-start items-center space-y-60 p-4">
            ...
            <div className="flex flex-col text-sm text-green font-medium text-start space-y-4">
              <div className="flex flex-row items-center text-md w-fit space-x-2 text-green-700">
                <BsShieldCheck className="w-5 h-5" />
                <span>Download app</span>
              </div>
              <div className="flex flex-row items-center text-md w-fit space-x-2 text-gray-400">
        ...
        {/* Right Side */}
        <div className="flex flex-col justify-center items-center text-start h-full px-4">
          {/* Header link */}
          <div className="w-full flex justify-end pt-4">
            <Link
              to="/"
          ...
          <div className="flex flex-col justify-center items-center flex-1 space-y-4">
            <div className="bg-green-50 bg-opacity-10 backdrop-blur-lg p-6 w-lg h-[350px] flex flex-col space-y-4">
              <div className="flex flex-row space-x-8 items-center justify-between">
                <div className="flex flex-col justify-between items-start h-full">
                  <div className="flex flex-col space-y-4 h-full justify-between items-start">
                    <div className="flex flex-col space-y-4">
                      <div className="flex flex-row space-x-2.5">
                        <img src={goog} className="w-5 h-5" alt="Google icon" />
                        <img
      ...
      <div className="md:hidden flex flex-col h-screen overflow-hidden">
        ...
        <div className="flex flex-col justify-between items-start text-start h-full px-4">
          ...
          {/* Centered content */}
          <div className="flex flex-col justify-center items-center flex-1 space-y-4">
            <div className="bg-green-50 bg-opacity-10 backdrop-blur-lg p-6 w-sm h-[300px] flex flex-col space-y-4">
              <div className="flex flex-row space-x-8 items-center justify-between">
                <div className="flex flex-col justify-between items-start h-full">
                ...
                {/* Image section */}
                <div className="relative bg-gray-200 bg-opacity-10 backdrop-blur-lg rounded-3xl p-3 w-2/5 h-[250px] overflow-hidden">
                  <img
                    src={icon}
                    className="absolute right-0 top-0 w-[350px] h-full object-contain"
                    alt="App icon"
                  />
                </div>
              </div>
            ...
            {/* Buttons */}
            <div className="flex flex-row space-x-4 items-center justify-center w-3/4 mt-2">
              <button
                type="button"
                onClick={prevPage}
                className="bg-[#2E5C38] cursor-pointer text-white px-10 py-2.5 rounded-lg text-sm font-medium flex items-center justify-center transition"
              >
                Previous
              </button>
              ...
              <button
                onClick={nextPage}
                type="button"
                className="bg-gray-500 cursor-pointer text-white px-10 py-2.5 rounded-lg text-sm font-medium flex items-center justify-center space-x-1 transition"
              >
                <span>Next</span>
              </button>
            </div>
