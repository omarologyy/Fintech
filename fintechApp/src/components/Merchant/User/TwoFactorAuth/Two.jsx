    ...
    <>
      ...
      <div className="hidden lg:flex flex-row h-screen space-x-32 overflow-hidden">
        ...
        <div className="flex flex-col justify-center items-start text-start h-full space-y-4 px-8">
          <div className="flex flex-col space-y-2">
            ...
            <p className="text-xs">Be sure to back up your 2-step secret key</p>
          </div>
          ...
          <p className="text-gray-400 text-sm">
            <span>This key will help you protect and recover</span>
            <br />
            <span>your account from fraudulent activity</span>
          </p>
      ...
      <div className="hidden lg:hidden md:flex flex-col h-screen overflow-hidden">
        ...
        <div className="relative h-full lg:w-1/2 flex flex-col items-center justify-start text-center space-y-10">
          ...
          />
          <div className="relative z-10 flex flex-col h-full justify-between items-center p-4">
            <p className="text-lg text-green-700 font-medium text-center self-center">
              Step 3/3 — 2-factor authenticator
            </p>
            <div className="flex flex-col text-sm text-green font-medium text-start space-y-4">
        ...
        <div className="flex flex-col justify-center items-center text-center h-full space-y-4 px-8">
          <div className="flex flex-col space-y-2">
            ...
            <p className="text-sm">Be sure to back up your 2-step secret key</p>
          </div>

          <form className="mt-3 w-2xs ">
            <div className="flex justify-between items-center border border-gray-300 rounded-md px-3 py-1 w-full">
              <input
                name="tel"
                type="text"
