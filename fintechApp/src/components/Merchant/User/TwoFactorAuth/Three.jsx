  ...
  return (
    <>
      ...
      <div className="hidden lg:hidden md:flex flex-col h-screen overflow-hidden">
        ...
        {/* Right hand side */}
        <div className="flex flex-col justify-center items-center text-start h-full space-y-4 px-4">
          <div className="flex flex-col space-y-12">
            <div className="flex flex-row space-x-8">
              <div className="flex flex-col space-y-2">
                <h1 className="text-3xl font-medium text-center">
        ...
        <div className="flex flex-col justify-center items-center text-start h-full space-y-4 px-4">
          <div className="flex flex-col space-y-12">
            <div className="flex flex-row space-x-8">
              ...
              <div className="flex flex-col justify-center items-center">
                <p className="text-xs">
                  This key will help you protect and recover your account from
                  fraudulent activity
                </p>
                <form className="mt-3 w-full">
                  <div className="flex justify-between items-center border border-gray-300 rounded-md px-3 py-1 w-full">
              ...
              <button
                ...
                className={`${
                  isFormComplete
                    ? "bg-[#2E5C38] cursor-pointer"
                    : "bg-gray-300 cursor-not-allowed"
                } text-white px-10 py-3 rounded-lg text-xs font-medium flex items-center justify-center transition`}
              >
                Previous
              </button>
              ...
              <button
                ...
                className={`${
                  isFormComplete
                    ? "bg-gray-500 cursor-pointer"
                    : "bg-gray-300 cursor-not-allowed"
                } text-white px-10 py-3 rounded-lg text-xs font-medium flex items-center justify-center space-x-1 transition`}
              >
                <span>Next</span>
              </button>
            </div>
